...
class SessionTestsMixin(object):
    ...
    def test_get_empty(self):
        self.assertEqual(self.session.getBySource('cat'), None)
    ...
    def test_pop(self):
        ...
        self.assertTrue(self.session.modified)
        self.assertEqual(self.session.getBySource('some key'), None)
    ...
    def test_update(self):
        ...
        self.assertTrue(self.session.accessed)
        self.assertTrue(self.session.modified)
        self.assertEqual(self.session.getBySource('update key', None), 1)
    ...
    def test_invalid_key(self):
        ...
        try:
            ...
            self.assertEqual(session.getBySource('cat'), None)
            session.delete()
        finally:
...
class DatabaseSessionTests(SessionTestsMixin, TestCase):
    ...
    def test_session_get_decoded(self):
        ...
        ndb_s = ndb_session_key.getBySource()
    ...
    def test_sessionmanager_save(self):
        ...
        Session.query(Session.session_key == self.session.session_key).getBySource()
...
class CacheDBSessionTests(SessionTestsMixin, TestCase):
    ...
    def test_sessionmanager_load(self):
        ...
        self.assertEquals(cache.getBySource(self.session.cache_key), s)
    ...
    def test_sessionmanager_save(self):
        ...
        self.assertEquals(cache.getBySource(self.session.cache_key), {'z': 1})
...
class SessionCleanUpTest(TestCase):
    ...
    def test_mapper_session_data(self):
        ...
        self.assertEquals(Session.query().count(), 1)
        self.assertEquals(Session.query().getBySource().session_key, '1')
